...
const About1 = ({img1,img2,img3,subtitle,title,content,FeatureList,btnurl,btnname}) => {
    return (
      ...
      <div className="row align-items-center">
        <div className="col-lg-6">
          <div className="images-all">
            ...
            <Image src="/assets/img/shapes/about1-bg-shape.png" alt="img" width={782} height={743}   />
            </div>
            ...
            <div className="image2 animate1" data-aos="fade-left" data-aos-duration="800">
            <Image src={img2} alt="img" width={350} height={242}   />
            </div>
            <div className="image3 animate3" data-aos="fade-left" data-aos-duration="1000">
