...
const About4 = ({subtitle,title,content,list1,list2,img1,img2,img3}) => {
    return (
                ...
                <div className="heading1">
                  ...
                  <div className="porgress-line-all">
                      <div className="progress-line">
                        <h6>{list1}</h6>
                        <div id="progress1" data-init="true"><div className="percentCount">100%</div><div className="progressbar" ><div className="proggress" ></div></div></div>
                      </div>
                      <div className="progress-line">
                        <h6>{list2}</h6>
                        <div id="progress1" data-init="true"><div className="percentCount">80%</div><div className="progressbar" ><div className="proggress" ></div></div></div>
                      </div>
                    </div>
                  <div className="space30"></div>
                  <div className="">
                    <Link className="theme-btn1" href="/contact">Explore Our Services <span><i className="bi bi-arrow-right"></i></span></Link>
                  </div>
                </div>
              </div>
