            ...
            <div className="col-lg-6 m-auto text-center">
              <div className="heading">
                ...
                <div className="form-area">
                  <a href="https://members.seotoolsgroupbuy.us/signup" className="theme-btn1" style={{display: 'inline-block', padding: '15px 40px', textDecoration: 'none'}} target="_blank" rel="noopener noreferrer">Buy Now <span><i className="bi bi-arrow-right"></i></span></a>
                </div>
              </div>
            </div>
          </div>
