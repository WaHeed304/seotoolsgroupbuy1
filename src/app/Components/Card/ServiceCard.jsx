          ...
          <div className="col-lg-7">
            <div className="tab-images-all">
              ...
              <div className="image2">
                <Image src={img1} alt="SEO Tool" width={200} height={200} />
              </div>
              <div className="image3 animate2">
                <Image src={img2} alt="SEO Tool" width={200} height={200} />
              </div>
              <div className="image4 animate1">
                <Image src={img3} alt="SEO Tool" width={200} height={200} />
              </div>
              <div className="image5">
                <Image src={img4} alt="SEO Tool" width={200} height={200} />
              </div>
            </div>
          </div>
        </div>
