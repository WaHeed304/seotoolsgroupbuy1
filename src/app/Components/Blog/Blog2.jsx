          ...
          <div className="col-lg-7">
            <div className="blog-box" data-aos="fade-right" data-aos-duration="800">
              ...
              <div className="heading3">
                ...
                <Link className="theme-btn2" href="/blog/blog-details">Read More <span><i className="bi bi-arrow-right"></i></span></Link>
              </div>
            </div>
          </div>
            ...
            <div className="" data-aos="fade-up" data-aos-duration="700">
              <div className="blog-box smoll">
                <div className="heading3">
                  ...
                  <h4><Link href="/blog/blog-details">Role of Technical SEO in Improving Your Website’s Performance in SEO</Link></h4>
                  <Link className="theme-btn2" href="/blog/blog-details">Read More <span><i className="bi bi-arrow-right"></i></span></Link>
                </div>
              </div>
            </div>
