                        ...
                        <div className="col-lg-7 m-auto text-center">
                            <div className="heading1">
                                ...
                                <Image src="/assets/img/icons/span1.svg" alt="img" width={21} height={20}   />
                                     Website Analysis</span></p>
                                <h2>Conduct Website Audience Analysis Explore Geography</h2>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div className="row align-items-center">
                                            ...
                                            <div className="services-seo-catagory">
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-3 col-3">
                                                        <div
                                                        className="services-seo-catagory-item services-seo-catagory-four d-flex align-items-center">
                                                        <div className="stable-rank"><span>4</span></div>
                                            ...
                                            <div className="services-seo-catagory">
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-3 col-3">
                                                        <div
                                                        className="services-seo-catagory-item services-seo-catagory-four d-flex align-items-center">
                                                        <div className="stable-rank"><span>0</span></div>
                                                        <div className="incridable-rank">
                                            ...
                                            <div className="services-seo-catagory">
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-3 col-3">
                                                        <div
                                                        className="services-seo-catagory-item services-seo-catagory-four d-flex align-items-center">
                                                        <div className="stable-rank"><span>3</span></div>
                                            ...
                                            <div className="services-seo-catagory">
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-3 col-3">
                                                        <div
                                                        className="services-seo-catagory-item services-seo-catagory-four d-flex align-items-center">
                                                        <div className="stable-rank"><span>5</span></div>
                                                        <div className="incridable-rank">
                                                            <i className="fa-solid fa-angle-up"></i>
                                                            <span>1</span>
                                                        </div>
